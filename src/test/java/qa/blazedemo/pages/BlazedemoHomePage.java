...
public class BlazedemoHomePage {
    ...
    public void chooseDepartureAndDestination(String departure){
        BrowserUtils.selectBy(this.departure, departure, "value");
    }
    public void chooseDestination(String destination) {
        BrowserUtils.selectBy(this.destination, destination, "value");
        findingFlights.click();
    }
    public void headerConfirm(String expected){
        Assert.assertEquals(expected, header.getText().trim());
    }

    public void clickFirstFlight(){
        allFlights.get(0).click(); //it clicks the first element from List
...
//        }
    ...
    public void providePersonalInformation(String fullName,String address,String city,String state,
                                           String zipCode){
    ...
    public void provideCardInformation(String cardType,String cardNumber,String month,String year,
                                       String nameOnCard){
    ...
    public void clickRememberMeAndPurchaseFlight(){
        remember.click();
