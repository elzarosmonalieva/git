...
import java.util.List;
    ...
    public class SignUpPage {
        ...
        public void signUpSecondPage(String fName, String lName, String compName, String bArea, String addrss, String crncy){
            ...
            JavascriptExecutor js1 = (JavascriptExecutor) DriverHelper.getDriver();
            js1.executeScript("arguments[0].scrollIntoView(true);", currency);
            js1.executeScript("arguments[0].click();", currency);
            ...
            JavascriptExecutor js2 = (JavascriptExecutor) DriverHelper.getDriver();
            js2.executeScript("arguments[0].click();", signUpBtn);
            // signUpBtn.click();
